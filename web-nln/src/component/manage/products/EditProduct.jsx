...
export default function EditProduct(){
  ...
  async function getProduct(id){
    const data = await axios.get(serverApi+"/products/"+id).then((res)=>{
  ...
  async function updateProduct(id){
    ...
    const response = await axios.put(serverApi + '/products/' + id, formData, {
      headers: {
    ...
    return(
        ...
        <div className="edit-label">
          ...
          <input type="text" id="name-product" className=" input-form" value={nameValue} onChange={(e) => setnameValue(e.target.value)}></input>
          ...
          <input type="text" id="characteristic" className=" input-form" value={featureValue} onChange={(e) => setfeatureValue(e.target.value)}></input>
          <label className="label form-product" htmlFor="summary">
            Mô tả nhanh
          </label>
          <input type="text" id="summary" className=" input-form" value={fastdescriptionValue} onChange={(e) => setfastdescriptionValue(e.target.value)} ></input>
          ...
          <input type="text" id="weight" className=" input-form" value={weightValue} onChange={(e) => setweightValue(e.target.value)}></input>
          ...
          <input type="text" id="quantity-in-warehouse" className=" input-form" value={quantitypValue} onChange={(e) => setquantitypValue(e.target.value)}></input>
